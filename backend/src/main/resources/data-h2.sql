...
-- Create roles (use MERGE to avoid duplicates)
...
KEY(id) VALUES (1, 'admin', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 
        'admin@example.com', 'Admin User', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Create test user (password: password)
MERGE INTO users (id, username, password, email, full_name, enabled, created_at, updated_at) 
KEY(id) VALUES (2, 'user', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 
...
KEY(id) VALUES (1, 'example/sample-repo', 'https://github.com/example/sample-repo.git', 'main', 
...
KEY(id) VALUES (1, 1, 42, 'Fix critical bug in authentication', 'This PR fixes a null pointer exception in the auth module',
